---
title: "03 - Reproducible Projects and Version Control"
...
|  `W:\`                         | Git branches                          |
| Ask tables (xlsx)              | Generate tables (SQL, dplyr, pandas)  |
|  ??                            | Reproducibility                       |
| Stata, SAS, EViews             | R, Python, Julia                      |
| Solo                           | Interdisciplinary teams               |
...
[<i class="fa fa-github"></i> Source code](https://github.com/itamarcaspi/boi-data-science-2019/blob/master/02-reprod-vc/02-reprod-vc.Rmd)  
