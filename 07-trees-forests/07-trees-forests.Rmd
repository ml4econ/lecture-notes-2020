...
- Instead of $SSR$, splits are typically based on the _Gini index_ (a.k.a _node purity_), defined by
...
knitr::include_graphics("https://en.wikipedia.org/wiki/File:RMS_Titanic_3.jpg")
```
]
...
```{r}
titanic_raw <- 
  here("07-nonparametrics/data", "titanic_varian.csv") %>% 
  read_csv()
```
